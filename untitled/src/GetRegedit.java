...
//public class GetRegedit {
//    public static void main(String[] args) throws InvocationTargetException, IllegalAccessException {
//        String value = GetRegeditValue.readString (
//                WinRegistry.HKEY_LOCAL_MACHINE,                             //HKEY
//                "SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion",           //Key
//                "ProductName");                                              //ValueName
//        System.out.println("Windows Distribution = " + value);
//
////        List<String> key1 = GetRegeditValue.readStringSubKeys (
////                WinRegistry.HKEY_CLASSES_ROOT,                             //HKEY
////                "Local Settings\\Software\\Microsoft\\Windows\\Shell\\MuiCache");                                              //ValueName
////        System.out.println("Windows Distribution = " + key1);
//
//        List<String> key1 = GetRegeditValue.readStringSubKeys (
//                WinRegistry.HKEY_LOCAL_MACHINE,                             //HKEY
//                "SOFTWARE\\AGEIA Technologies\\PhysX_A64_Engines");                                              //ValueName
//        System.out.println("Windows Distribution = " + key1);
//
//        List<String> ls = GetRegeditValue.readStringSubKeys(WinRegistry.HKEY_LOCAL_MACHINE,
//                "SOFTWARE\\AGEIA Technologies\\PhysX_A64_Engines");
//        String key = ls.stream().filter(st -> st.matches("Maxima.*")).findAny().get();
//        System.out.println(key);
//
//    }
//}
//class GetRegeditValue {
